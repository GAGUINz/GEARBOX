  ...
  return (
    ...
    >
      <style jsx>{`
        ...
        .gold-mode .header h2,
        .gold-mode p:not(.heroP),
        .gold-mode > * > * :not(.contact-btn):not(.heroT) {
        ...
        @media (max-width: 768px) {
          .gold-mode .header .spotlight {
            filter: invert(1) brightness(1.2) opacity(0.06) !important;
          }
          .gold-mode canvas {
        ...
        <div
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.boxShadow = isGoldMode
              ? (isMobile ? "0 0 1em 0 rgba(216, 189, 16, 0.15)" : "-0.3em 0.1em 0.2em 0 #d8bd10")
              : (isMobile ? "0 0 1em 0 rgba(152, 192, 239, 0.15)" : "-0.3em 0.1em 0.2em 0 #98c0ef")
          }}
          onMouseLeave={(e) => {
            const isMobile = window.innerWidth <= 768;
            e.currentTarget.style.boxShadow = isGoldMode 
              ? (isMobile ? "0 0 1em 0 rgba(216, 189, 16, 0.1)" : "0 0 1em 0 #d8bd10")
              : (isMobile ? "0 0 1em 0 rgba(152, 192, 239, 0.1)" : "0 0 1em 0 #98c0ef")
          }}
        />
      ...
      {/* Hero */}
      <div
        className="hero mx-auto max-w-3xl flex justify-center mt-60 h-[300px]"
      >
        <div
          className="heroT notranslate"
          translate="no"
          style={{
            position: "absolute",
            left: 0,
        ...
        >
          <h2
            style={{
              ...
              fontSize: "7em",
              fontWeight: 800,
              opacity: isGoldMode ? 1 : 0.2,
              textShadow: isGoldMode ? "0 2px 25px rgba(234, 88, 12, 0.6)" : "none",
              animation: "pulse 10s linear 1.2s infinite",
              transitionProperty: "--p, opacity, text-shadow",
            ...
            <span
              style={{
                backgroundImage: `
                  ...
                  ${isGoldMode ? "linear-gradient(0deg, #ea580c 30%, #fdba74 100%)" : "linear-gradient(0deg, rgba(255,255,255,0.1) 30%, rgba(255,255,255,0.3) 100%)"}
                `,
                backgroundClip: "text",
            ...
            <span
              style={{
                backgroundImage: `
                  ...
                  ${isGoldMode ? "linear-gradient(0deg, #000000 30%, #444444 100%)" : "linear-gradient(0deg, rgba(255,255,255,0.1) 30%, rgba(255,255,255,0.3) 100%)"}
                `,
                backgroundClip: "text",
                WebkitBackgroundClip: "text",
                WebkitTextFillColor: "transparent",
          ...
          <h2
            ...
            style={{
              ...
              fontWeight: 800,
              filter: "blur(16px)",
              opacity: isGoldMode ? 0.6 : 0,
              animation: "pulse 10s linear 1.2s infinite",
              transitionProperty: "--p, opacity",
              transitionDuration: "1s",
            }}
          >
            <span
      ...
      >
        <div
          ...
          style={{
            ...
            color: isGoldMode ? "#fdba74" : "#a1a1aa",
            fontSize: "0.85rem",
            fontWeight: "600",
            letterSpacing: "0.1em",
